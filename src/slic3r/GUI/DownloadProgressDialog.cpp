...
{
    wxString download_failed_url = wxT("https://docs.3dlabs.io/en/software/bambu-studio/failed-to-get-network-plugin");
    wxString install_failed_url = wxT("https://docs.3dlabs.io/en/software/bambu-studio/failed-to-get-network-plugin");
