...
static const wxColour BUTTON_HOVER_COL   = wxColour(72, 94, 112);
...
static const wxColour STAGE_TEXT_COL      = wxColour(72, 94, 112);
...
void PrintingTaskPanel::create_panel(wxWindow* parent)
{
   ...
   /* wxFlexGridSizer *fgSizer_task = new wxFlexGridSizer(2, 2, 0, 0);
    ...
    m_staticText_progress_percent->SetForegroundColour(wxColour(72, 94, 112));
    ...
    m_staticText_progress_percent_icon->SetForegroundColour(wxColour(72, 94, 112));
...
wxBoxSizer *StatusBasePanel::create_machine_control_page(wxWindow *parent)
{
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(AMS_CONTROL_DISABLE_COLOUR, StateColor::Disabled), std::pair<wxColour, int>(wxColour(82, 142, 255), StateColor::Pressed),
        std::pair<wxColour, int>(wxColour(82, 142, 255), StateColor::Hovered), std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
    StateColor btn_bd_green(std::pair<wxColour, int>(AMS_CONTROL_WHITE_COLOUR, StateColor::Disabled), std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Enabled));
...
wxBoxSizer *StatusBasePanel::create_misc_control(wxWindow *parent)
{
    ...
    m_switch_nozzle_fan->Bind(wxEVT_ENTER_WINDOW, [this](auto& e) {
        m_fan_panel->SetBackgroundColor(wxColour(82, 142, 255));
    });
