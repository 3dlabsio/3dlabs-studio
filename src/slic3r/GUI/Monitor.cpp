 ...
 void MonitorPanel::init_tabpanel()
{
   ...
   /* auto warning_panel = new wxPanel(this, wxID_ANY);
    ...
    m_hyperlink = new wxHyperlinkCtrl(m_connection_info, wxID_ANY, _L("Failed to connect to the server"), wxT("https://docs.3dlabs.io/3dlabs-studio/failed-to-connect-printer"), wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE);
