    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxSize(42 * wxGetApp().em_unit(), -1)), p(new priv(parent))
{
    ...
    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour(82, 142, 255), StateColor::Pressed),
                            std::pair<wxColour, int>(wxColour(82, 142, 255), StateColor::Hovered),
...
void Sidebar::sync_ams_list()
{
    ...
    if (unknowns > 0) {
        MessageDialog dlg(this,
            _L("There are some unknown filaments mapped to generic preset. Please update 3DLabs Studio or restart 3DLabs Studio to check if there is an update to system presets."),
            _L("Sync filaments with AMS"), wxOK);
        dlg.ShowModal();
    }
...
Plater::priv::priv(Plater *q, MainFrame *main_frame)
    ...
    , config(Slic3r::DynamicPrintConfig::new_from_defaults_keys({
        ...
        "support_top_z_distance", "support_bottom_z_distance", "raft_layers", "best_object_pos"
        }))
                    ...
                    if (en_3mf_file_type == En3mfType::From_Prusa) {
                        ...
                        if (load_type != LoadType::LoadGeometry) {
                            if (en_3mf_file_type == En3mfType::From_BBS)
                                show_info(q, _L("The 3mf is generated by old 3DLabs Studio, load geometry data only."), _L("Load 3mf"));
                            else
                                show_info(q, _L("The 3mf is not supported by OrcaSlicer, load geometry data only."), _L("Load 3mf"));
                        }
                ...
                wxCAPTION | wxCLOSE_BOX)
{
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(82, 142, 255), StateColor::Pressed), std::pair<wxColour, int>(wxColour(82, 142, 255), StateColor::Hovered),
                            std::pair<wxColour, int>(wxColour(82, 142, 255), StateColor::Normal));

    m_confirm->SetBackgroundColor(btn_bg_green);
    m_confirm->SetBorderColor(wxColour(82, 142, 255));
...
void Plater::show_object_info()
{
    ...
    if (non_manifold_edges > 0) {
        info_manifold += into_u8("\n" + _L("Tips:") + "\n" +_L("\"Fix Model\" feature is currently only on Windows. Please repair the model on 3DLabs Studio(windows) or CAD softwares."));
    }
    #endif //APPLE & LINUX
