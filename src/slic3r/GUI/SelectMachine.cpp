    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    auto m_hyperlink = new wxHyperlinkCtrl(m_panel_prepare, wxID_ANY, _L("Can't find my devices?"), wxT("https://docs.3dlabs.io/3dlabs-studio/failed-to-connect-printer"), wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE);
