...
void ImGuiWrapper::init_font(bool compress)
{
    ...
    default_font = io.Fonts->AddFontFromFileTTF((Slic3r::resources_dir() + "/fonts/" + "Rubik-Regular.ttf").c_str(), m_font_size, &cfg, ImGui::GetIO().Fonts->GetGlyphRangesChineseFull());
    ...
    bold_font        = io.Fonts->AddFontFromFileTTF((Slic3r::resources_dir() + "/fonts/" + "Rubik-Bold.ttf").c_str(), m_font_size, &cfg, ranges.Data);
