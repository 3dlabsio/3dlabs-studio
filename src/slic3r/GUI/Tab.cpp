...
/*#ifdef __WXOSX__
    ...
    if (dynamic_cast<TabPrint*>(this) == nullptr) {
        m_static_title = new Label(m_top_panel, Label::Body_12, _L("Expert"));
...
void TabPrint::build()
{
    ...
    auto page = add_options_page(L("Quality"), "empty");
        ...
        optgroup->append_single_option_line("elephant_foot_compensation_layers");
        ...
        optgroup = page->new_optgroup(L("Walls and surfaces"), L"param_walls_surfaces");
        ...
        optgroup->append_single_option_line("bridge_counterbored_holes");
...
void TabPrinter::build_unregular_pages(bool from_initial_build/* = false*/)
{
    ...
    bool		show_mach_limits = (flavor == gcfMarlinLegacy || flavor == gcfMarlinFirmware || flavor == gcfKlipper);
