...
Button* MsgDialog::add_button(wxWindowID btn_id, bool set_focus /*= false*/, const wxString& label/* = wxString()*/)
{
    ...
    StateColor btn_bg_green(
        ...
        std::pair<wxColour, int>(wxColour(91, 160, 216), StateColor::Hovered),
	...
	, msg(msg)
{
	...
	logo->SetBitmap(create_scaled_bitmap("3DLabsStudio_192px_grayscale.png", this, monospaced_font ? 48 : /*1*/84));
