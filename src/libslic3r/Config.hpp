...
// When parsing a configuration value, if the old_value is not understood by this 3DLabsStudio version,
// it is being substituted with some default value that this 3DLabsStudio could work with.
