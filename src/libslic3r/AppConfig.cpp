...
static const std::string VERSION_CHECK_URL_STABLE = "https://api.github.com/repos/3dlabsio/3dlabs-studio-release/releases/latest";
static const std::string VERSION_CHECK_URL = "https://api.github.com/repos/3dlabsio/3dlabs-studio-release/releases";
static const std::string PROFILE_UPDATE_URL = "https://api.github.com/repos/3dlabsio/3dlabs-studio-profiles/releases/tags";
