...
#define SLIC3R_APP_FULL_NAME "3DLabs Studio"
#define GCODEVIEWER_APP_NAME "3DLabs G-code Viewer"
#define GCODEVIEWER_APP_KEY  "3DLabsStudioGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("3DLabsStudio G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
