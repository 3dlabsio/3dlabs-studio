...
static std::vector<std::string> s_Preset_print_options {
    ...
    "seam_position", "staggered_inner_seams", "sparse_infill_density", "sparse_infill_pattern", "top_surface_pattern", "bottom_surface_pattern",
    "infill_direction",
    ...
    "flush_into_infill", "flush_into_objects", "flush_into_support",
     ...
     "make_overhang_printable", "make_overhang_printable_angle", "make_overhang_printable_hole_size" ,"notes" ,"initial_layer_min_bead_width","tree_support_branch_distance_organic", "tree_support_branch_diameter_organic", "tree_support_branch_angle_organic",
     "hole_to_polyhole", "hole_to_polyhole_threshold", "hole_to_polyhole_twisted"
};

static std::vector<std::string> s_Preset_filament_options {
    /*"filament_colour", */"default_filament_colour","required_nozzle_HRC", "filament_diameter", "filament_type", "filament_soluble", "filament_is_support", "filament_max_volumetric_speed",
    "filament_flow_ratio", "enable_pressure_advance", "pressure_advance", "filament_density", "filament_cost", "filament_minimal_purge_on_wipe_tower", "idle_temperature",
