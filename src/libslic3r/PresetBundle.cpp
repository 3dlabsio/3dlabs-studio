...
const char *PresetBundle::BBL_BUNDLE = "3DLabs";
const char *PresetBundle::BBL_DEFAULT_PRINTER_MODEL = "3D Labs HTX";
const char *PresetBundle::BBL_DEFAULT_PRINTER_VARIANT = "0.4";
const char *PresetBundle::BBL_DEFAULT_FILAMENT = "ABS";
...
void PresetBundle::update_selections(AppConfig &config)
{
    ...
    filament_colors.resize(filament_presets.size(), "#1b6391");
