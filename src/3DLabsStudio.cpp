...
int CLI::run(int argc, char **argv)
{
    ...
    set_current_thread_name("labs_studio_main");
    ...
    BOOST_LOG_TRIVIAL(info) << "Current 3DLabsStudio Version "<< SoftFever_VERSION << std::endl;
...
bool CLI::setup(int argc, char **argv)
{
    ...
    if (BlacklistedLibraryCheck::get_instance().perform_check()) {
        ...
        text += L"\n\n"
                L"3DLabsStudio is known to not run correctly with these DLLs injected. "
                L"We suggest stopping or uninstalling these services if you experience "
                L"crashes or unexpected behaviour while using 3DLabsStudio.\n"
...
extern "C" {
    __declspec(dllexport) int __stdcall labs_studio_main(int argc, wchar_t **argv)
    {
